    ...
    class Fretboard {
      constructor() {
        ...
        $canvas.on("pointerdown", (e) => {
          ...
          if (this.pointerOverFB && this.pointerString < this.brokenStrings.length) {
            this.brokenStrings[this.pointerString] = true;
          }
        });
        $$.on("pointerup blur", (e) => {
        ...
        this.brokenStrings = new Array(this.strings.length).fill(false);
      }
      ...
      draw() {
        ...
        for (s = k = 0, len = ref1.length; k < len; s = ++k) {
          ...
          if (this.brokenStrings[s]) // Don't draw string if it's broken.
            continue;
